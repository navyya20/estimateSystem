...
public class BillSiDTO extends BillCommonDTO {
	String documentNum;
	String estimateNum;
	int userNum;
	String userName;
	...
	public ArrayList<BillSiItemDTO> getItems() {
		return items;
	}
	public void setItems(ArrayList<BillSiItemDTO> items) {
		this.items = items;
	}
	@Override
	public String toString() {
		return "BillSiDTO [documentNum=" + documentNum + ", estimateNum=" + estimateNum + ", userNum=" + userNum
				...
				+ ", workPeriodStart=" + workPeriodStart + ", workPeriodEnd=" + workPeriodEnd + ", items=" + items
