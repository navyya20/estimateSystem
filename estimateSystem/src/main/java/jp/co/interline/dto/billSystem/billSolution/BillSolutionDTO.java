package jp.co.interline.dto.billSystem.billSolution;
...
public class BillSolutionDTO extends BillCommonDTO {
	String documentNum;
	String estimateNum;
	int userNum;
	String userName;
	...
	@JsonProperty("items")
	ArrayList<BillSolutionItemDTO> items;
	...
	public ArrayList<BillSolutionItemDTO> getItems() {
		return items;
	}
	public void setItems(ArrayList<BillSolutionItemDTO> items) {
		this.items = items;
	}
	@Override
	public String toString() {
		return "BillSolutionDTO [documentNum=" + documentNum + ", estimateNum=" + estimateNum + ", userNum=" + userNum
				...
				+ ", payCondition=" + payCondition + ", deadline=" + deadline + ", items=" + items + ", bankName="
				+ bankName + ", branchName=" + branchName + ", accountName=" + accountName + ", hurigana=" + hurigana
				+ ", accountNumber=" + accountNumber + ", depositeClassification=" + depositeClassification + ", note="
				+ note + ", sum=" + sum + ", taxRate=" + taxRate + ", tax=" + tax + ", sumWithTax=" + sumWithTax
