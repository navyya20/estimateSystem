...
public class FileService {
	 ...
	 * @return 저장된 파일명
	 */
	public static String saveFile(MultipartFile mfile, String uploadPath, String savedFilename ,String category) {
		...
		while (true) {
			serverFile = new File(uploadPath + "/" + category + index + ext);
			//같은 이름의 파일이 없으면 나감.
