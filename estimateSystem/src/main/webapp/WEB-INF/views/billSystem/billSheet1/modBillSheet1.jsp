...
<body class="body" style="height: 100%;">
	...
	<script type="text/javascript" >
		...
		function SetOZParamters_OZViewer(){
			...
			oz.sendToActionScript("odi.odinames", "modBillSheet1");
	 		oz.sendToActionScript("odi.modBillSheet1.pcount", "1");
			oz.sendToActionScript("odi.modBillSheet1.args1", "documentNum="+'${billNum}');
			oz.sendToActionScript("pdf.fontembedding","true");
			return true;
		}
