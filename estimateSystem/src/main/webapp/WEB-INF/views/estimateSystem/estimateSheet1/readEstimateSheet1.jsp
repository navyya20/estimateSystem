...
<title>readEstimateSheet1</title>
<style type="text/css">
</style>
<script>
...
<body class="body" style="height: 100%;">
	...
	<script type="text/javascript" >
		function SetOZParamters_OZViewer(){			
			...
			oz.sendToActionScript("odi.odinames", "readEstimateSheet1");
	 		oz.sendToActionScript("odi.readEstimateSheet1.pcount", "1");
			oz.sendToActionScript("odi.readEstimateSheet1.args1", "documentNum="+'${estimateNum}');
